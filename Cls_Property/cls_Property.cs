...
namespace Property_cls
{
    public class cls_Property
    {
        ...
        public int Insert_AddLease(string name, string emailid, string phoneno, string priceRange, string city, string property, string propertyDetail)
        {
            int result = 0;
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "usp_AddLease";
                cmd.Parameters.AddWithValue("@name", name);
                cmd.Parameters.AddWithValue("@emailid", emailid);
                cmd.Parameters.AddWithValue("@phonenumber", phoneno);
                cmd.Parameters.AddWithValue("@pricerange", priceRange);
                cmd.Parameters.AddWithValue("@city", city);
                cmd.Parameters.AddWithValue("@propertyType", property);
                cmd.Parameters.AddWithValue("@propertyTypeDetails", propertyDetail);
                cmd.Connection = conn;
                if (conn.State == ConnectionState.Closed)
                {
                    conn.Open();
