<%@ Page Title="" Language="C#" MasterPageFile="~/PropertyNew.Master" AutoEventWireup="true" CodeBehind="Lease.aspx.cs" Inherits="Property.Lease" %>
        ...
        <div class="wrapper_new">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="contact_in_left">
                    ...
                    <asp:DropDownList ID="ddlPtypeDetails" runat="server">
